...
from HBAPP.models import superadminreg,mstitemlist,CustomerData,itemorderdetails
...
def Cart(request):
    ...
    if itemorderdetails.objects.all().exists():
        data=itemorderdetails.objects.all()
    return render(request,"ctcart.html",{"data":data,"msg":msg})
