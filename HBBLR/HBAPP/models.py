...
class customeroderdetails(models.Model):
    ...
    status=models.CharField(max_length=122,default="new oder")
    accepted_date_time=models.CharField(max_length=100)
    accepted_by=models.CharField(max_length=100, default=0)
    Regicted_by=models.CharField(max_length=100, default=0)
    Recevied_by=models.CharField(max_length=100, default=0)
    completedstatus=models.CharField(max_length=100,default=0)
    delivery_by_id=models.CharField(max_length=100,default=0)
...
class itemorderdetails(models.Model):
    ...
    hotelid=models.CharField(max_length=50,default="")
